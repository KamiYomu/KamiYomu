...
{
    public class ChapterCancelOnFailAttribute : JobFilterAttribute, IApplyStateFilter, IDisposable
    {
        ...
        public ChapterCancelOnFailAttribute(string libraryIdParameterName, string cancelReason = "The number of attempts was exceeded")
        {
